  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-6 select-none">
      <div className={`relative ${dimensions} flex items-center justify-center`}>
        ...
        <div className="absolute inset-0 rounded-full border-2 border-t-indigo-500 border-r-violet-400 border-b-transparent border-l-transparent animate-spin" />
        {/* Center Point */}
        <div className="w-2 h-2 rounded-full bg-indigo-400 shadow-[0_0_8px_rgba(99,102,241,0.9)]" />
      </div>
...
export function PageLoader() {
  ...
  return (
    ...
    >
      <div className="h-full bg-gradient-to-r from-indigo-500 via-violet-400 to-indigo-500 animate-[progress-scan_0.6s_ease-in-out_infinite]" />
    </div>
  );
}
